...
const initPage = () => {
  try {
    ...
    const CONFIG = {
      headlinePrincipal: "+100 Técnicas de Massagem <br><span class='hl-pink'>Ilustradas para Combater a Calvície</span>",
      subheadlineDeApoio: "Mais de 100 técnicas, sequências de massagem, estímulos manuais e mapas visuais passo a passo para combater calvície, entradas, rarefação e queda capilar em homens e mulheres.",
      nomeMaterialPrincipal: "+100 Técnicas de Massagem Ilustradas para Combater a Calvície",
      ...
      nomeDoBonus1: "Checklist da Rotina Anti-Calvície",
      nomeDoBonus2: "Kit de Cuidados Caseiros para o Couro Cabeludo",
      nomeDoBonus3: "Guia Visual de Alimentação e Nutrientes para os Cabelos",
      descricaoBreveDoBonus1: "Um checklist visual para organizar os cuidados ao longo da semana, acompanhar hábitos, frequência das massagens, lavagem e cuidados com o couro cabeludo.",
      descricaoBreveDoBonus2: "Um material visual com cuidados caseiros, receitas de tônicos, óleos naturais, aplicação e orientações de uso ilustradas.",
      descricaoBreveDoBonus3: "Um guia visual mostrando alimentos, vitaminas e nutrientes essenciais para fortalecer a raiz e estimular os folículos capilares.",
      valorBonus1: "R$ 27,90",
      valorBonus2: "R$ 27,90",
      valorBonus3: "R$ 19,90",
      ...
      linkCheckoutPlanoCompleto: "https://ggcheckout.app/checkout/v5/bDzsItFlIYZSYSbPdnTV",
    ...
    if (TIMER_SETTING.isRelative) {
      const storageKey = "massagem_calvicie_offer_deadline";
      let storedDeadline;
      try {
    ...
    const drawSvgPlaceholders = () => {
      document.querySelectorAll("img").forEach(img => {
        ...
        if (src && src.startsWith("[") && src.endsWith("]")) {
          ...
          <rect width="calc(100% - 8px)" height="calc(100% - 8px)" x="4" y="4" fill="none" stroke="#0761F9" stroke-width="1.5" rx="8"/>
        ...
        img.addEventListener("error", () => {
          const label = img.getAttribute("alt") || "Técnicas de Massagem contra a Calvície";
